...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-wbvrayy.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-wbvrayy.containers.anotherwebservice.com/
...
```
git clone git@github.com:bahadur21656/container-wbvrayy.git
cd container-wbvrayy
```
...
```
docker attach container-wbvrayy
```
